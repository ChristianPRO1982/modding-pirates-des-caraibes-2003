...
void ProcessDialogEvent()
{
	...
	switch (pchar.location) {
		...
		case "Muelle_town_02": amantFirstName = "Gregorio"; amantLastName = "de Acosta"; smjhFirstName = "Alejandrina"; smjhLastName = "Acosto"; smjhJewelry = "une broche en argent de son pays natal."; break;

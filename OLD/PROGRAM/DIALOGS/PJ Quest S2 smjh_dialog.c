...
void ProcessDialogEvent()
{
	...
	switch (pchar.location) {
		...
		case "Conceicao_town": amantFirstName = "Florencio"; amantLastName = "Baiano"; smjhFirstName = "Violante"; smjhLastName = "Pinto"; smjhJewelry = "une broche en or."; smjhJewelryID = "jewelry14"; break;
		case "Muelle_town_04": amantFirstName = "Gregorio"; amantLastName = "de Acosta"; smjhFirstName = "Alejandrina"; smjhLastName = "Acosto"; smjhJewelry = "une broche en argent de son pays natal."; smjhJewelryID = "jewelry13"; break;

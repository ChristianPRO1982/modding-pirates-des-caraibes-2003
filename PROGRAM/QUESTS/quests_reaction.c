...
void QuestComplete(string sQuestName)
{
	...
	switch(sQuestName)
	{
		...
		//Ïåðñîíàæ ïîêèäàåò Îêñáýé â ïåðâûé ðàç - âêëþ÷åíèå ïåðâîãî ñþæåòíîãî ðîëèêà
		case "Story_leavingOxbay":
			...
			//Ïîñòàíîâêà â ãàâàíü Îêñáýÿ êîðàáëåé ôðàíöóçñêîé ýñêàäðû
			...
			//Çàâåäåíèå êâåñòà íà äèàëîã ñ ñîëäàòàìè ó âõîäà â ãîðîä Îêñáýé ñ îñòðîâà
		...
		//Ïðè çàõîäå èãðîêà â ðåçèäåíöèþ Ðåäìîíäà Ðåéìñ ïîêèäàåò åå
		...
		case "Story_MassoniStartTalkingInTavern":
			...
			//Óíè÷òîæàåì êâåñò íà àòàêó ñîëäàò â äæóíãëÿõ
		...
		case "Story_Massony_Reload_to_Town":
			//Ñìåíà Äèàëîãà Ñòðàæíèêàì íà âîðîòàõ
			...
			//Óñòàíîâêè èì âñåì âðåìåííîãî áåññìåðòèÿ
			...
			LAi_SetStayType(pchar);
			//Ñìåíà òèïà Âàëåíòèíó Ìàññîíè			
			LAi_SetActorType(characterFromID("Valentin Massoni"));

			//Ïåðåìåùåíèå Ìàññîíè è Áëýéçà ê âûõîäó èç Îêñáýÿ
		...
		//Ìàññîíè îòïðàâëÿåòñÿ ê ëîêàòîðó ðåëîàäà, ÷òîáû âûéòè èç ãîðîäà.
		case "Story_Massoni_leave_Oxbay":
			//Ìàññîíè ïåðåãðóæàåòñÿ â âûõîä èç Îêñáýÿ
		...
		case "prepare_FRANCE_SOLDIERS_return_to_post":
			...
			LAi_SetPlayerType(pchar);
			//Èãðîê ïîêèäàåò ãîðîä âñëåä çà Ìàññîíè
			...
			//Ìàññîíè óõîäèò â âîðîòà Îêñáýÿ
			...
			//Óñòàíàâëèâàåòñÿ äèàëîã äëÿ Ìàññîíè
		...
		//èãðîê âûõîäèò â äæóíãëè âñëåä çà Ìàññîíè
		...
		//Èãðîê è ïüÿíûé Ìàññîíè èäóò â äæóíãëÿõ, è äîéäÿ äî ëîêàòîðà, ìàññîíè íà÷èíàåò äèàëîã
		...
		//èãðîê äîõîäèò äî ëîêàòîðà ãäå Ìàññîíè îòêàçûâàåòñÿ èäòè äàëüøå
		...
		case "Massoni_spared":
			...
			//Êâåñò íà ïîÿâëåíèå Áëýéçà íà Ôàëå äå Ôëåð
			...
			//Êâåñò íà ïîòîïëåíèå áàðêà "Îéñó"
		...
		//Ìàññîíè äîáåãàåò äî âîðîò è ïðèêàçûâàåò ñòðàæíèêàì, åñëè îíè åùå åñòü, óáèòü Áëýéçà
		...
		//Ñîëäàòû çàâÿçûâàþò ñ èãðîêîì ðàçãîâîðîì, êîãäà îí ïîäõîäèò ê Îêñáýþ ñ ñóøè.
		...
		//Áëýéç â ïåðâûé ðàç ïðèïëûâàåò íà Ôàëå äå Ôëåð, ÷òîáû ïîãîâîðèòü ñ Áåðàíæåðå
		...
		//Áëýéç òîïèò ñíàáæåí÷åñêèé áàðê Oiseau, îñòàâëÿÿ ôðàíöóçîâ áåç áîåïðèïàñîâ.
		...
		//Áëýéç ïðèïëûâàåò ñ áàðêîì Îéñó íà ëþáîé îñòðîâ.
		...
		case "Story_Blaze_and_Boon_leaving":
			...
			//------------Âûäà÷à Êâåñòîâ íà íàïàäåíèå Áóíà íà èãðîêà
		...
		case "Ewan_exit_business":
			...
			//---------Âîçâðàùàåì îáîèì òèï ñòîÿùèõ.
			LAi_SetCitizenType(characterfromID("Ewan Glover"));
			//---------Íà÷èíàåì ïðîâåðêó íà ïîïàäàíèå èãðîêà è Ãëîóâåðà â ëîêåéøåí íî÷íîé âûñàäêè
			Pchar.quest.Story_Blaze_and_Glover_Land_troops.win_condition.l1 = "location";
			Pchar.quest.Story_Blaze_and_Glover_Land_troops.win_condition.l1.location = "Oxbay_shore_02";
			Pchar.quest.Story_Blaze_and_Glover_Land_troops.win_condition.l2 = "Ship_location";
			Pchar.quest.Story_Blaze_and_Glover_Land_troops.win_condition.l2.location = "Oxbay_shore_02";
		...
		case "Ewan_Glover_exit_join":
			...
			//-------ïåðåìåùàåì ìåñòíîãî æèòåëÿ ê ïðè÷àëó Ãðèíôîðäà
			ChangeCharacterAddress(characterFromID("Wilfred"), "Greenford_port", "goto20");
			//-------Çàâîäèì êâåñò íà ïîïàäàíèå èãðîêà â ïîðò Ãðèíôîðäà
		...
		case "prepare_Story_ReloadedtoGreenfordTavernWithGlover":
			SetCurrentTime(23, 0);
			//---------Òåëåïîðòèðóåì Ãëîóâåðà è èãðîêà â òàâåðíó Ãðèíôîðäà
		...
		case "Story_Glover_goes_to_tavern":
			//--------ïåðåìåùàåì Ýâàíà Ãëîóâåðà â íèêóäà... Ïðåäïîëîæèòåëüíî, îí â òàâåðíå Ðåäìîíäà
			ChangeCharacterAddress(characterFromID("Ewan Glover"), "None", "");
			Pchar.Quest.Story_Ask_for_Glover = "1";
		break;

		case "Story_Glover_leaves_tavern":
			//--------ïåðåìåùàåì Ýâàíà Ãëîóâåðà â íèêóäà... Ïðåäïîëîæèòåëüíî, îí íà ñâîåì êîðàáëå
		...
		case "Story_Blaze_reaches_Greenford":
			...
			Lai_SetStayType(pchar);
			//---------ñòàâèì ðÿäîì ñ Áëýéçîì Ýâàíà Ãëîóâåðà
		...
		case "Story_Blaze_reaches_Greenford_2":
			...
			//---------Íà âñÿêèé ñëó÷àé äåëàåì åãî áåññìåðòíûì
			LAi_SetImmortal(characterFromID("Wilfred"), true);
		break;

		case "Wilfred_exit_failed":
			//--------Îòïðàâêà Óèëôðåäà â âîðîòà Ãðèíôîðäà.
		...
		case "Wilfred_Exit_failed_in_last_moment":
			//--------Îòïðàâêà Óèëôðåäà ê ëîêàòîðó ðåëîàäà.
		...
		case "Story_Wilfred_leaves_forever":
			//---------Îòïðàâëÿåì Óèëôðåäà â íèêóäà, ñ÷èòàÿ ÷òî îí îò ãîðÿ ñáåæàë äîìîé
			ChangeCharacterAddress(characterFromID("Wilfred"), "None", "");
		break;

		case "Story_Convoy_Glover_to_Greenford":
			AddQuestRecord("Story_2ndTask", "4");
			//--------Çà÷èñëÿåì èãðîêó ïðîâàëåííûé êâåñò
			Pchar.quest.Story_Glover_sunk = true;
			//--------Ñòàðòóåì âòîðóþ ïîëîâèíó çàäàíèÿ
			Pchar.quest.Story_2ndTask = "Second_part";
			LAi_SetSitType(characterFromID("CounterSpy"));
			ChangeCharacterAddressGroup(characterFromID("CounterSpy"), "Oxbay_tavern", "Sit", "Sit6");
			Characters[GetCharacterIndex("CounterSpy")].Dialog.CurrentNode = "Met_Blaze";
		...
		case "Story_Wilfred_go_to_shore_prepare":
			...
			//---------Óñòàíîâêà äèàëîãà Ýâàíó Ãëîóâåðó
		...
		case "Story_Wilfred_go_to_shore":
			//---------Îòïðàâëÿåì Óèëôðåäà â íèêóäà, ñ÷èòàÿ ÷òî îí îòïðàâèëñÿ íà áåðåã âñòðå÷àòü Áëýéçà
			ChangeCharacterAddress(characterFromID("Wilfred"), "None", "");
		break;
		...
		case "Wilfred_exit_fight":			
			...
			//--------Îòïðàâêà Óèëôðåäà ê ëîêàòîðó, ãäå îí áóäåò áîÿòüñÿ.
			LAi_SetImmortal(characterFromID("Wilfred"), true);
			Locations[FindLocation("Oxbay_shore_02")].reload.l3.disable = 1;
		break;

		case "Story_Glover_to_tavern_on_Greenford":
			//----------Âûñòàâëÿåì Ãëîóâåðó ñèäÿ÷óþ ïîçèöèþ.
			LAi_type_actor_Reset(characterFromID("Ewan Glover"));
			LAi_SetSitType(characterFromID("Ewan Glover"));
			//---------Ïåðåãðóæàåì Ýâàíà Ãëîóâåðà â òàâåðíó Ãðèíôîðäà, ãäå îí áóäåò æäàòü èãðîêà.
			ChangeCharacterAddressGroup(characterFromID("Ewan Glover"), "Greenford_tavern", "sit", "sit4");
			Characters[GetCharacterIndex("Ewan Glover")].Dialog.CurrentNode = "Are_you_ready_again";
		break;
		...
		case "Wilfred_exit_complete":
			//-----------Âîçâðàùàåì èãðîêà â òàâåðíó Ãðèíôîðäà íà ñëåä. äåíü
		...
		case "Story_ReturnedToGreenfordTavern":
			...
			//-----------Âîçâðàùàåì âîçìîæíîñòü âûõîäà â êàðòó
			bQuestDisableMapEnter = false;
			//-----------Ýâàí Ãëîóâåð íà÷èíàåò äèàëîã ñ èãðîêîì.
			LAi_SetActorType(characterFromID("Ewan Glover"));
			LAi_SetActorType(pchar);
		...
		case "Blaze_and_Counterspy_exit_from_shipyard":
			...
			//----------------ïåðåãðóçèòü èãðîêà è øïèîíà íàâåðõ âåðôè
		...
		case "Story_HiddenInShipyardWatch_2":
			...
			//----------------Íà÷àòü äèàëîã ìåæäó ñîëäàòàìè è Îóýíîì
		...
		case "Story_LeaveOxbayWithRabelAndCounterspy":
			...
			//---------Íà ñëó÷àé, åñëè èãðîê ïåðâûì äîáåæèò äî âîðîò.
		...
		case "Story_FightingInGreenfordPort":
			//-----------------Âîçâðàùåíèå ñîñòîÿíèÿ Ðåëîàäîâ îñòðîâà Îêñáýé è âîññòàíîâëåíèå âûõîäà â êàðòó
			Island_SetReloadEnableGlobal("Oxbay", true);
			//Âîññòàíîâëåíèå àäðåñà ëîêàòîðà ïåðåãðóçêè â Ïîðò Ãðèíôîðäà âìåñòî ôýéêîâîãî Ãðèíôîðäà
			Islands[3].reload.l2.name = "reload_1";
		...
		case "Story_WeMadeThem":
			...
			bQuestDisableMapEnter = false;
			//-----------------Âîçâðàùåíèå ñîñòîÿíèÿ ðåëîàäà âûõîäà èç ãðèíôîðäñêîé òàâåðíû
			Locations[FindLocation("Greenford_tavern")].reload.l1.name = "reload1";
		...
		case "exit_from_silehard_complete":
			...
			//Äåëàåì íåâîçìîæíîñòü óéòè èç ëîêàöèè
		...
		//ñîëäàò â òàâåðíå áüåò íàñ ïî ìîðäe
		...
		case "fighting_in_tavern":
			...
			//òðàêòèðùèê óáåãàåò â îáû÷íóþ (íå êâåñòîâóþ òàâåðíó)
		...
		//Äàíèåëü óáåãàåò èç òàâåðíû, îñòàâëÿÿ òàì Áëåéçà
		...
		//òðàêòèðùèê óáåãàåò èç êâåñòîâîé òàâåðíû
		...
		case "blaze_exit_from_cam_complete":
			...
			//äàåì êâåñò íà óáèéñòâî âñåõ ñòðàæíèêîâ â òþðüìå
		...
		case "kill_edgard_in_prison_2_complete":
			if (pchar.location == "redmond_prison")
			{
				...
				//ñîëäàòû ñëûøàò øóì è èäóò âîåâàòü èãðîêà.
		...
		//ïðîõîäèì çà ñàéëõàðäîì â åãî êàáèíåò
		case "blaze_from_prison_to_residence_complete":
			...
			//Ñìåíà ôðàíöóçñêèõ ñîëäàò â Îêñáýå íà àíãëèéñêèõ
			//Óäàëåíèå ôðàíöóçñêèõ
			...
			//Óáèðàíèå èç ãàâàíè Îêñáýÿ êîðàáëåé ôðàíöóçñêîé ýñêàäðû
			Group_SetAddress("Story_French_Squadron", "none", "Quest_Ships","Quest_Ship_7");
		...
		//óáèòü âñåõ ñîëäàò â òþðüìå
		case "kill_all_soldiers_in_prison_complete":
			LAi_group_SetRelation("ENGLAND_SOLDIERS", LAI_GROUP_PLAYER, LAI_GROUP_FRIEND);
			//ïîÿâëåíèÿ ãóáåðíàòîðà ñî ñòðàæíèêàìè è íà÷àëî ðàçãîâîðà
		...
		//áëåéç äîñòèãàåò ëîêàòîðà â òþðüìå, çà êîòîðûì åãî âèäÿò ñòðàæíèêè
		...
		//ïîÿâëåíèå ìóæèêà, äàþùåãî èíôîðìàöèþ î ìåñòîíàõîæäåíèè ðåéìñà
		...
		case "kill_pirate_for_rheims_lore_complete":
			...
			//âîçðàæäàåì ïèðàòà äëÿ ñëåäóþùèõ ñöåíîê
		...
		//ãîâîðèì êîíòðàáàíäèñòàì îòâåñòè áëåéçà ê êàìèëî ìà÷àäî
		...
		//ïåðâûé ðàç ïîïàäàåì â äîì ê Ìà÷àäî
		...
		//Òðàêòèðùèê íà Äóâåçåíå óõîäèò çà ïèðàòîì
		...
		//ïèðàò îáúÿñíÿåò íàì êàê ïîïàñòü â ëîãîâî ïèðàòîâ
		...
		//íà÷èíàåòñÿ ñöåíêà ñ èçîáðåòàòåëåì
		...
		//âîçâðàùàåìñÿ íà ìàÿê äëÿ ðàçãîâîðà äàíèýëü è îòïëûòèÿ çà ðåéìñîì
		...
		//ïðèáûâàåì íà ïåðâûé ïëÿæ äóâåçåíà
		...
		//ïðèáûâàåì íà âòîðîé ïëÿæ äóâåçåíà
		...
		//çàõîäèì â òàâåðíó çà Âèíñåòîì, êîòîðûé ïîêàæåò íàì ðåéìñà
		...
		//Âèíñåíò èäåò çà ñâîèìè ãîëîâîðåçàìè
		...
		//âûõîäèì â ãîðîä è íà íàñ íàïàäþò ãîëîâîðåçû
		...
		//Áëýéç ñëûøèò äèàëîã Äàíèåëü ñ Ðåéìñîì
		...
		//âêëþ÷àåì ðîëèê, ðàññòàâëÿåì âñåõ ïåðñîíàæåé.
		...
		case "OnUse_Idol": //èñïîëüçóåì ñòàòóþ èäîëüñêóþ.
			bMainMenuLaunchAfterVideo = true;
		...
		case "Counterspy_After_Fight_Exit":
			//-------------Çàâîäèòñÿ êâåñò íà ïîïàäàíèå â âåðôü Îêñáýÿ
			...
			//-------------Çàâîäèòñÿ êâåñò íà Ïîïûòêó ñáåæàòü èç ãîðîäà â äæóíãëè
			...
			//-----------Ïðèñîåäèíåíèå øïèîíà â êà÷åñòâå îôèöåðà		
		...
		///////////////////////////////////////////////////////////////
		// êâåñòîâàÿ ëèíåéêà èãðû â êîñòè
		///////////////////////////////////////////////////////////////
		...
		///////////////////////////////////////////////////////////////
		// êâåñòîâàÿ ëèíåéêà çîëîòîé øàõòû
		///////////////////////////////////////////////////////////////

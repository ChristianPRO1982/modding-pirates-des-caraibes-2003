...
//Artois Voysey
	...
	break;
		...
		case "PJ_end_MQ":
			...
			DoQuestReloadToLocation("redmond_residence", "goto", "goto3", "blaze_from_prison_to_residence_complete");
			// la ligne si dessous uniquement pour le dйveloppement de la quкte G1
			...
			// les lignes ci-dessous uniquement pour le dйveloppement de la quкte B1.2a
			// elles simulent une B1.1 dйjа terminйe pour proposer directement B1.2 chez Silehard

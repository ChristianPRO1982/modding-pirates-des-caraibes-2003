//nclude "DIALOGS\PJ Quest S2 Falaise de Fleur smjh_dialog.h"
void ProcessDialogEvent()
{
	...
	amantFullName = "Fabrisse De Lucien";
	smjhJewelry = "une bague en or sertie de saphirs.";
	smjhJewelryID = "jewelry10";

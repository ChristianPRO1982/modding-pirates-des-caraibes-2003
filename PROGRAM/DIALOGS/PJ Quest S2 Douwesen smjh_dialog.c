//nclude "DIALOGS\PJ Quest S2 Douwesen smjh_dialog.h"
void ProcessDialogEvent()
{
	...
	amantFullName = "Ghijsbrecht Van Der Hagen";
	smjhJewelry = "bague en argent sertie de saphirs.";
	smjhJewelryID = "jewelry6";

...
int CreateTempQuestCharacters(int n)
{
	...
	ch.location.group = "";
	ch.location.locator = "";
	ch.Dialog.Filename = "PJ Quest M2 Sir Henry Huncks_dialog.c";
	ch.rank 	= 1;
	ch.reputation = "1";
	ch.experience = "0";
	ch.skill.Leadership = "8";
	...
	ch.location.group = "";
	ch.location.locator = "";
	ch.Dialog.Filename = "PJ Quest M2 robber man.c";
	ch.rank 	= 1;
	ch.reputation = "1";
	ch.experience = "0";
	ch.skill.Leadership = "8";
	...
	ch.location.group = "";
	ch.location.locator = "";
	ch.Dialog.Filename = "PJ Quest M2 robber woman.c";
	ch.rank 	= 1;
	ch.reputation = "1";
	ch.experience = "0";
	ch.skill.Leadership = "8";
	...
	LAi_SetImmortal(ch, true);
	ch.name 	= "Carmen";
	ch.lastname 	= "San Diego";
	ch.id		= "Carmen San Diego";
	ch.model = "towngirl7";
	ch.sex = "woman";
	ch.sound_type = "female_citizen";
	LAi_NoRebirthEnable(ch);
	...
	ch.location.group = "";
	ch.location.locator = "";
	ch.Dialog.Filename = "PJ Quest M2 Carmen San Diego.c";
	ch.rank 	= 1;
	ch.reputation = "1";
	ch.experience = "0";
	ch.skill.Leadership = "8";

...
int CreateTempQuestCharacters(int n)
{
	...
	makeref(ch,Characters[n]);			// Ethilrede Claar - ïèðàò, êîòîðûé ïðîäàë â ðàáñòâî îäíîãî èç íàøèõ îôèöåðîâ () Leborio Drago
	ch.name 	= "Ethilrede";
	ch.lastname 	= "Dubois";
	...
	makeref(ch,Characters[n]);			// Stephan Bonser - êîíòðàáàíäèñò íà ïëÿæå ðåäìîíäà
	ch.name 	= "Stephan";
	ch.lastname 	= "Bonser";
	...
	makeref(ch,Characters[n]);			// Wilfred Bythesea - òàê, ñòàðûé çíàêîìû Áëýéçà, ïîÿâëÿþùèéñÿ ýïèçîäè÷åñêè
	ch.name 	= "Wilfred";
	...
	makeref(ch,Characters[n]);			// Oswald Chappel - êîíòðàáàíäèñò íà ïëÿæå ðåäìîíäà
	ch.name 	= "Oswald";
	ch.lastname 	= "Chappel";
	...
	makeref(ch,Characters[n]);			// Gyles Dubois - êîíòðàáàíäèñò íà ïëÿæå ðåäìîíäà
	ch.name 	= "Gyles";
	ch.lastname 	= "Dubois";
	ch.id		= "Gyles Dubois";
	ch.model = "fisherman";
...
//Êîíòðàáàíäèñòû äëÿ ïåðåâîçêè êîíòðàáàíäû


	makeref(ch,Characters[n]);			// êîíòðàáàíäèñò 1
	ch.name 	= "Contrebandier";
	ch.lastname 	= "";
	ch.id		= "Rand_Smug01";
//	ch.model = "sat_monk";
...
//	ch.act.escape = 0;
	...
	makeref(ch,Characters[n]);			// êîíòðàáàíäèñò 2
	ch.name 	= "Contrebandier";
	ch.lastname 	= "";
	ch.id		= "Rand_Smug02";
//	ch.model = "sat_monk";
...
//	ch.act.escape = 0;
	...
	makeref(ch,Characters[n]);			// êîíòðàáàíäèñò 3
	ch.name 	= "Contrebandier";
	ch.lastname 	= "";
	ch.id		= "Rand_Smug03";
//	ch.model = "sat_monk";
...
//	ch.act.escape = 0;
	...
	makeref(ch,Characters[n]);			// Bernardo Gamboa - èñïàíåö. êîðñàð íà ñëóæáå ãîëëàíäèè
	ch.name 	= "Bernardo";
	ch.lastname 	= "Gamboa";
	...
	makeref(ch,Characters[n]);			// Corentin Lucay - ïîìîùíèê ïåðäûäóùåãî ïåðñà
	ch.name 	= "Corentin";
	ch.lastname 	= "Lucay";
	...
	makeref(ch,Characters[n]);		//ïåðâûé êàïèòàí áåðåãîâîé ñòðàæè
	ch.name 	= " ";
	ch.lastname = " ";
...
//	ch.Dialog.Filename = "blaze_dialog.c";
	...
	makeref(ch,Characters[n]);		//âòîðîé êàïèòàí áåðåãîâîé ñòðàæè
	ch.name 	= " ";
	ch.lastname = " ";
...
//	ch.Dialog.Filename = "blaze_dialog.c";
	...
	makeref(ch,Characters[n]);		//òðåòèé êàïèòàí áåðåãîâîé ñòðàæè
	ch.name 	= " ";
	ch.lastname = " ";
...
//	ch.Dialog.Filename = "blaze_dialog.c";
	...
	makeref(ch,Characters[n]);			// Mergildo Hurtado - êàïèòàí áàðêà ñî ñâÿùåííèêàìè
	ch.name 	= "Mergildo";
	ch.lastname 	= "Hurtado";
	...
	makeref(ch,Characters[n]);			// Jordano - ñûí êóçíåöà íà Ìóýëå
	ch.name 	= "Jordano";
	ch.lastname 	= "";
	ch.id		= "Jordano";
	ch.model = "man4";
...
//Cursed Coins Quest
	...
	makeref(ch,Characters[n]);		//ïåðâûé êàïèòàí-ìñòèòåëü çà ïîðóãàííöþ ÷åñòü ðîñòîâùèêà
	ch.name 	= " ";
	ch.lastname = " ";
	...
	makeref(ch,Characters[n]);		//âòîðîé êàïèòàí-ìñòèòåëü çà ïîðóãàííöþ ÷åñòü ðîñòîâùèêà
	ch.name 	= " ";
	ch.lastname = " ";
	...
	makeref(ch,Characters[n]);		//òðåòèé êàïèòàí-ìñòèòåëü çà ïîðóãàííöþ ÷åñòü ðîñòîâùèêà
	ch.name 	= " ";
	ch.lastname = " ";
